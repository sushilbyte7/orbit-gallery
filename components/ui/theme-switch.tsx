        ...
        >
            ...
            <Switch
                ...
                className={cn(
                    ...
                    "data-[state=checked]:[&>span]:translate-x-8" // 32 ≈ w-14(56) - padding - thumb(20)
                )}
            />
            ...
            <span
                className={cn(
                    "pointer-events-none absolute left-[7px] inset-y-0 z-0",
            ...
            <span
                className={cn(
                    "pointer-events-none absolute right-[7px] inset-y-0 z-0",
                    "flex items-center justify-center"
                )}
            >
                <MoonIcon
